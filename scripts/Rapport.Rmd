...
indep_vars_list <- list(
  "Modèle 1a" = c("Usage_MS"),
  "Modèle 1b" = c("age", "sexe", "Lieu_de_residence", "lieu_de_naissance", 
                  "Diplome_du_repondant", "Occupation_du_repondant","Nombre_d_heures_sur_RSM_Jour"),
  "Modèle 1c" = c("Diplome_mere", "Diplome_pere", "Situation_civile_parents", 
                  "Occupation_mere", "Occupation_pere"),
  "Modèle 1d" = c("Suivre_activité_amis_et_famille", "Communiquer_amis_et_famille", 
...
# X.2. Variable Utilisation des médias 
```{r}
#install.packages("sjPlot")
library(sjPlot)
# Fonction pour générer un modèle logistique
...
plot_models(
  ...
  show.p = FALSE,  # Ne pas afficher les p-valeurs
  show.legend = F,
  p.shape = F,  # Afficher les formes des points au lieu des valeurs
  grid = TRUE  # Afficher une grille
)

# Générer le graphique et enregistrer dans le dossier 'figures/forestplot'
ggsave(here("figures", "forestplot", "Utilisation des médias_forestplot1.png"), 
       plot = last_plot(), width = 10, height = 6)
...
# X.3.  nombre de de compte des médias
```{r}
# Fonction pour générer un modèle logistique
generate_logistic_model <- function(dep_var, indep_var, data) {
  formula <- as.formula(paste(dep_var, "~", indep_var))
...
# X.4 nombre de de compte des médias 
```{r}
# Fonction pour générer un modèle logistique
generate_logistic_model <- function(dep_var, indep_var, data) {
  formula <- as.formula(paste(dep_var, "~", indep_var))
...
plot_models(
  ...
  show.p = FALSE,  # Ne pas afficher les p-valeurs
  p.shape = F, 
  show.legend = F,# Afficher les formes des points au lieu des valeurs
  grid = TRUE# Afficher une grille
)


# Générer le graphique et enregistrer dans le dossier 'figures/forestplot'
ggsave(here("figures", "forestplot", "nombre de de compte des médias_forestplot1.png"), 
       plot = last_plot(), width = 10, height = 6)
...
# X.5. Variable utilisation de compte regulier
```{r}
# Fonction pour générer un modèle logistique
generate_logistic_model <- function(dep_var, indep_var, data) {
  formula <- as.formula(paste(dep_var, "~", indep_var))
...
# X.6. Variable utilisation de compte regulier 
```{r}
# Fonction pour générer un modèle logistique
generate_logistic_model <- function(dep_var, indep_var, data) {
  formula <- as.formula(paste(dep_var, "~", indep_var))
...
# Générer le graphique et enregistrer dans le dossier 'figures/forestplot'
ggsave(here("figures", "forestplot", "nombre de de compte regulier_forestplot1.png"), 
       plot = last_plot(), width = 10, height = 6)
...
p <- plot_models(
  ...
  scale_linetype_manual(values = rep("solid", length(dependent_vars))) +  
  scale_size_manual(values = rep(1.2, length(dependent_vars)))  
...
# Enregistrement du graphique
ggsave(here("figures", "forestplot", "nombre_d_heures_sur_RSM_Jour_forestplot1.png"), 
       plot = p, width = 10, height = 6)
p
```
...
# X.9.. variables concernant les médias
```{r}
# Fonction pour générer un modèle logistique
generate_logistic_model <- function(dep_var, indep_var, data) {
  formula <- as.formula(paste(dep_var, "~", indep_var))
...
# X.10. variables concernant les médias 
```{r}
# Fonction pour générer un modèle logistique
generate_logistic_model <- function(dep_var, indep_var, data) {
  formula <- as.formula(paste(dep_var, "~", indep_var))
...
# Générer le graphique et enregistrer dans le dossier 'figures/forestplot'
ggsave(here("figures", "forestplot", "Toute _les variables_utilisation des médias_forestplot1.png"), 
       plot = last_plot(), width = 10, height = 6)
